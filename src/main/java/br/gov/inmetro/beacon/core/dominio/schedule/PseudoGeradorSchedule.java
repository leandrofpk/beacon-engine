...
public class PseudoGeradorSchedule {
    ...
    private void gerarRegistro(){
        ...
        br.gov.inmetro.beacon.core.dominio.Registro r = new br.gov.inmetro.beacon.core.dominio.Registro(gerarNumero512(), LocalDateTime.now().truncatedTo(ChronoUnit.MINUTES), assinatura);
